    ...
    <div className="relative z-10 flex flex-col md:flex-row gap-3 md:gap-10 items-stretch w-full max-w-[1600px] mx-auto">
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-3 md:gap-4">
        <div>
          ...
          <h1 className="text-2xl md:text-6xl font-bold text-foreground mb-1 md:mb-4 leading-tight">SoundCloud Reposts</h1>
        ...
        <GlassPanel variant="bright" className="p-4 md:hidden">
          <div className="space-y-1.5">
            <div className="flex items-start gap-1.5">
              ...
              <p className="text-xs text-muted-foreground">Verified network of SoundCloud accounts with real followers — genre-aligned, fully tracked</p>
            </div>
            <div className="flex items-start gap-1.5">
              <div className="w-1.5 h-1.5 rounded-full bg-primary/60 shrink-0 mt-1.5" />
              <p className="text-xs text-muted-foreground">Early engagement signals compound into organic plays, likes & follows</p>
            </div>
            <div className="flex items-start gap-1.5">
              <div className="w-1.5 h-1.5 rounded-full bg-primary/60 shrink-0 mt-1.5" />
              <p className="text-xs text-muted-foreground">25M+ follower reach · Timeframe: 2–8 weeks</p>
            </div>
          </div>
        </GlassPanel>
