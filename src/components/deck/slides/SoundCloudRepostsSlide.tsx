    ...
    <div className="relative z-10 flex flex-col md:flex-row gap-4 md:gap-10 items-stretch w-full max-w-[1600px] mx-auto">
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-3 md:gap-4">
        <div>
          ...
          <h1 className="text-2xl md:text-6xl font-bold text-foreground mb-2 md:mb-4 leading-tight">SoundCloud Reposts</h1>
        ...
        <GlassPanel variant="bright" className="p-4 md:p-8 flex-1">
          ...
          <div className="pt-3 border-t border-white/[0.06] mt-3">
            <p className="text-xs md:text-2xl text-primary font-medium">Total group reach: 25M+ followers · Timeframe: 2 to 8 weeks</p>
          </div>
        </GlassPanel>
      </div>
          ...
          <GlassPanel key={idx} variant="bright" className="p-2 md:p-5 flex flex-col">
            <div className="flex gap-2 md:gap-4 mb-1 md:mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[9px] md:text-lg text-primary font-mono tracking-widest mb-0.5">REPOSTS</p>
