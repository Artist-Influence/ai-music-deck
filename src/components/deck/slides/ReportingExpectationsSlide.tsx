    ...
    <div className="relative z-10 w-full max-w-[1600px] grid grid-cols-2 gap-8 items-stretch py-4">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-4 flex-1">
          <GlassPanel variant="bright" className="p-6 text-left flex flex-col flex-1">
          ...
          <GlassPanel variant="subtle" className="p-6 text-left flex flex-col flex-1">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-4">
          <GlassPanel variant="bright" className="p-6 text-left flex flex-col">
