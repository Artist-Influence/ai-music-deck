    ...
    <div className="w-full h-full bg-background relative overflow-hidden p-5 md:p-24 flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto">
        <div className="max-w-[1200px] mx-auto">
          <h1 className="text-2xl md:text-6xl font-bold text-foreground mb-2 md:mb-4">{t('csSubtronics.title')}</h1>
          <p className="text-sm md:text-xl text-muted-foreground mb-6 md:mb-12">{t('csSubtronics.subtitle')}</p>
        </div>
