    ...
    <div className="relative z-10 flex flex-col md:flex-row gap-2 md:gap-10 items-stretch w-full max-w-[1600px] mx-auto">
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-2 md:gap-4">
        <div>
          ...
          <h1 className="text-xl md:text-6xl font-bold text-foreground mb-1 md:mb-4 leading-tight">Spotify Playlisting</h1>
        ...
        <GlassPanel variant="bright" className="p-3 md:hidden">
          <div className="space-y-1">
            <div className="flex items-start gap-1.5">
              ...
              <p className="text-[10px] text-muted-foreground">Curated playlists run by real tastemakers — no bots, genre-aligned</p>
            </div>
            <div className="flex items-start gap-1.5">
              <div className="w-1 h-1 rounded-full bg-primary/60 shrink-0 mt-1.5" />
              <p className="text-[10px] text-muted-foreground">Organic streams generate saves, follows & algorithmic signals</p>
            </div>
            <div className="flex items-start gap-1.5">
              <div className="w-1 h-1 rounded-full bg-primary/60 shrink-0 mt-1.5" />
              <p className="text-[10px] text-muted-foreground">Stream goals guaranteed · Timeframe: 12 weeks</p>
            </div>
          </div>
        </GlassPanel>
          ...
          <GlassPanel key={idx} variant="bright" className="p-1.5 md:p-5 flex flex-col">
            <div className="flex gap-1.5 md:gap-4 mb-0.5 md:mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[8px] md:text-lg text-primary font-mono tracking-widest mb-0.5">PLAYLISTING</p>
            ...
            <div className="flex gap-0.5 md:gap-2">
              {c.playlists.map((pl) => (
                <a key={pl.label} href={pl.url} target="_blank" rel="noopener noreferrer"
                  className="flex-1 inline-flex items-center justify-center gap-0.5 text-[8px] md:text-sm text-primary border border-primary/20 rounded px-1 py-0.5 md:px-3 md:py-1.5 hover:bg-primary/10 transition-colors">
