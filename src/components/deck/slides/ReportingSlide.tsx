...
const ReportingSlide = () => (
  <div className="w-full h-full bg-background relative overflow-hidden p-12 flex flex-col items-center justify-center">
    ...
    <div className="relative z-10 w-full max-w-[1400px] text-center">
      <h1 className="text-6xl font-bold text-foreground mb-4">You'll never wonder what's happening.</h1>
      <p className="text-2xl text-muted-foreground mb-16">Reporting and transparency</p>

      <div className="grid grid-cols-2 gap-8 max-w-[1400px] mx-auto">
        <GlassPanel variant="bright" className="p-12">
          <p className="text-2xl font-semibold text-primary mb-8">Weekly updates include</p>
        ...
        <GlassPanel variant="subtle" className="p-12">
          <p className="text-2xl font-semibold text-muted-foreground mb-8">Final recap includes</p>
