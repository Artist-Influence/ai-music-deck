  ...
  <div className="w-full h-full bg-background relative overflow-hidden p-5 md:p-24 flex flex-col items-center justify-center">
    ...
    <div className="relative z-10 flex flex-col md:flex-row gap-6 md:gap-12 items-start w-full max-w-[1600px] mx-auto">
      <div className="flex-1 max-w-[800px]">
        <h1 className="text-2xl md:text-7xl font-bold text-foreground mb-4 md:mb-10 leading-tight md:whitespace-nowrap">Music discovery has changed.</h1>
        ...
        <p className="text-sm md:text-lg text-primary font-medium mb-4 md:mb-6 tracking-wider uppercase">What wins today</p>
