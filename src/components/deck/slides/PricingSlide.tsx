  ...
  return (
    <div className="w-full min-h-dvh md:h-full bg-background relative overflow-hidden p-5 md:p-12 flex flex-col items-center justify-start md:justify-center">
      ...
      <div className="relative z-10 w-full max-w-[1400px]">
        <h1 className="t-hero text-2xl md:text-7xl text-on-visual mb-2 md:mb-4">{t('pricing.title')}</h1>
          ...
          <table className="w-full hidden md:table">
            <thead>
              <tr className="border-b border-white/[0.08]">
                <th className="text-left p-6 mono text-sm text-muted-foreground uppercase tracking-[0.15em]">{t('pricing.headerService')}</th>
                <th className="text-left p-6 mono text-sm text-muted-foreground uppercase tracking-[0.15em]">{t('pricing.headerUnit')}</th>
                <th className="text-left p-6 mono text-sm text-muted-foreground uppercase tracking-[0.15em]">{t('pricing.headerNote')}</th>
              </tr>
            </thead>
            <tbody>
              {services.map((s, i) => (
