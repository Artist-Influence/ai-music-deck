    ...
    <div className="relative z-10 flex flex-col md:flex-row gap-2 md:gap-10 items-stretch w-full max-w-[1600px] mx-auto">
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-2 md:gap-4">
        <div>
          ...
          <h1 className="text-xl md:text-6xl font-bold text-foreground mb-1 md:mb-4 leading-tight">Instagram Seeding</h1>
        ...
        <GlassPanel variant="bright" className="p-3 md:hidden">
          <div className="space-y-1">
            <div className="flex items-start gap-1.5">
              ...
              <p className="text-[10px] text-muted-foreground">Audio & video seeded across curated IG theme pages & meme accounts</p>
            </div>
            <div className="flex items-start gap-1.5">
              <div className="w-1 h-1 rounded-full bg-primary/60 shrink-0 mt-1.5" />
              <p className="text-[10px] text-muted-foreground">Drives saves, shares & audio uses at a fraction of paid ad cost</p>
            </div>
            <div className="flex items-start gap-1.5">
              <div className="w-1 h-1 rounded-full bg-primary/60 shrink-0 mt-1.5" />
              <p className="text-[10px] text-muted-foreground">Built for relevance & cost efficiency · Timeframe: 1–3 weeks</p>
            </div>
          </div>
        </GlassPanel>
          ...
          <GlassPanel key={idx} variant="bright" className="p-1.5 md:p-5 flex flex-col">
            <div className="flex gap-1.5 md:gap-4 mb-0.5 md:mb-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[8px] md:text-lg text-primary font-mono tracking-widest mb-0.5">SEEDING</p>
            ...
            <div className="grid grid-cols-3 gap-0.5 md:gap-2">
              {c.metrics.map((m) => (
                <div key={m.label} className="bg-white/[0.04] rounded p-0.5 md:p-3 flex flex-col items-center justify-center text-center">
