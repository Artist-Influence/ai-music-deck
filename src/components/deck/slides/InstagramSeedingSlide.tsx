    ...
    <div className="w-full min-h-dvh md:h-full bg-background relative overflow-x-hidden md:overflow-hidden py-6 px-5 md:p-12 flex flex-col justify-start md:justify-center">
      ...
      <div className="relative z-10 flex flex-col gap-3 md:gap-4 w-full max-w-[1600px] mx-auto">
        ...
        <div>
          ...
          <h1 className="text-2xl md:text-6xl font-bold text-foreground mb-1 md:mb-4 leading-tight">{t('instagram.title')}</h1>
          <p className="text-xs md:text-2xl text-foreground/80 mb-0 max-w-[700px] [text-shadow:0_1px_12px_hsl(var(--background)/0.7)]">{t('instagram.subtitle')}</p>
        </div>
