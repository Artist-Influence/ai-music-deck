...
const en: Record<string, string> = {
  ...
  'howWeWork.reporting.1': 'Top creatives, patterns worth doubling down on, and recommendations for the next release',
  'howWeWork.reporting.2': 'Platform metrics that matter and results by service with best-performing angles',
