...
const en: Record<string, string> = {
  ...
  'howWeWork.reporting.1': 'Top creatives, winning patterns, and next-release recommendations',
  'howWeWork.reporting.2': 'Key platform metrics, results by service, and best-performing angles',
